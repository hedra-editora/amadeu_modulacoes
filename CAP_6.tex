...
\begin{flushright}
\emph{Mariella Batarra Mian\footnote{Graduada em Comunicação Social -- Habilitação em Relações Públicas -- pela Unesp, Especialista em Gestão de Marketing pela \versal{FAAP}, Mestre em Ciências Humanas e Sociais pela \versal{UFABC}. Atualmente, cursa doutorado em Ciências Humanas e Sociais Na \versal{UFABC}. Pesquisa cibercultura e tecnopolítica.}}
\end{flushright}

%Doutorado em andamento no programa de pós"-graduação em Ciências Humanas e Sociais pela Universidade Federal do \versal{ABC} (\versal{UFABC}). Mestre pelo mesmo programa da \versal{UFABC}. Especialista em Gestão de Marketing pela Fundação Armando Álvares Penteado (\versal{FAAP}). Graduada em comunicação social -- habilitação em Relações Públicas, pela Universidade Estadual Paulista (\versal{UNESP}). Atua como Relações Públicas na Universidade Federal do \versal{ABC}.\\  E"-mail: \emph{mariellabm@gmail.com}
...
objetivos que lhes são atribuídos'' (\versal{CASTELLS}, 2009, p. 76, tradução nossa)\footnote{Citação original: ``\emph{La capacidad de constituir redes y de
...
\parbox{225pt}{\caption{Figura 3 -- Print da postagem com vídeo sobre coleta de dados pessoais e campanha \#PerguntePorque (\versal{INTERNETLAB}, 2018b).}}
%\end{minipage}
 \end{figure}
...
\parbox{225pt}{\caption{Figura 4 -- Print com alguns comentários na postagem da página do InternetLab para a campanha \#PerguntePorque (\versal{INTERNETLAB}, 2018b).}}
%\end{minipage}
 \end{figure}
