...
no inciso X do artigo quinto da Constituição de 1988. (\versal{BRASIL}, 2018)
...
and Principles Dynamic Coalition (\versal{IRPC})}\footnote{A \emph{Internet
  ...
  direitos humanos (\versal{IRPC}, 2018\textsuperscript{a}, tradução nossa).}\emph{''}
reconhecida pela Organização das Nações Unidas (\versal{ONU}).
...
eliminação e divulgação de dados pessoais (\versal{IRPC}, 2018b, 8)
\end{quote}
...
dos próprios cidadãos em seu cotidiano. O já citado \versal{INTERNETLAB}, em uma
...
\caption{Figura 5 -- Print com alguns comentários na postagem da página do \versal{INERNETLAB} para a campanha \#PerguntePorque (\versal{INTERNETLAB}, 2018b)}
%\end{minipage}
 \end{figure}
...
do \versal{INTERNETLAB} com os usuários, a campanha vem acompanhada da palavra
...
(\versal{INTERNETLAB}, \versal{LABLIVRE}, \versal{CGI}"-\versal{BR} e \versal{IRPC}) e, ainda que sistematicamente
