...
\begin{flushright}
\emph{João Francisco Cassino\footnote{Mestrando em Ciências Humanas e Sociais (\versal{UFABC}), especialista em Relações Internacionais (\versal{U}n\versal{B}), \versal{MBA} em Gestão Empresarial (\versal{FGV-RJ}) e graduado em Jornalismo (Cásper Líbero). Funcionário de carreira da \versal{BB} Tecnologia e Serviços (Conglomerado Banco do Brasil).}}
\end{flushright}

%\bigskip

\begin{flushright}
\small{\emph{``Quem controla o passado, controla o futuro. Quem controla o presente, controla o passado.''}\\
George Orwell, \emph{1984}}
\end{flushright}

\begin{flushright}
\small{\emph{``Já deixamos a era da disciplina para entrar no tempo do controle.''}\\
Maurizio Lazzarato, \emph{As Revoluções do Capitalismo}}
\end{flushright}
...
\caption{\versal{GRÁFICO} 1 -- Fluxo de Desenvolvimento Teórico.}
%\end{minipage}
\end{figure}
...
prazo'' (\versal{CASTELLS}, 2017, p. 209), escreve. Quando mecanismos emocionais
...
jornais, ou dos que nem chegaram a ela (\versal{BARROS}, 1996, p. 28).
\end{quote}
...
mercados (\versal{LIMA, M}.; \emph{et al}., 2007, p. 19, \emph{apud} \versal{BRANSTAD} e \versal{LUCIER}, 2001).
\end{quote}
...
maioria, vazios de toda singularidade (\versal{LAZZARATO}, 2006, p. 101).
\end{quote}
...
\caption{\versal{GRÁFICO} 2 -- Subconjuntos da Modulação Deleuzeana.}
%\end{minipage}
 \end{figure}
...
mercados (\ldots{}) (2001. \emph{In}: \versal{LIMA, M}.; \emph{et al}., 2007, p. 23).
\end{quote}
...
\versal{BARROS FILHO}, Clóvis de. \emph{Agenda setting e educação}. \emph{In}:
...
\versal{BASTA}, D.; \versal{MARCHESI}, F. R. de A.; \versal{OLIVEIRA}, J. A. F. de; \versal{SÁ}, L. C. S. de. \emph{Fundamentos de Marketing} -- 7ª Edição. Série Gestão
Empresarial. Rio de Janeiro. Editora \versal{FGV}, 2006.

\versal{CASTELLS}, Manuel. \emph{O Poder da Comunicação}, pp. 209-210. 2ª
Edição. Rio de Janeiro/São Paulo. Editora Paz e Terra, 2017.

\versal{DAVENPORT}, Thomas H.; \versal{BECK}, John C. \emph{The Attention Economy:
...
\versal{FOUCAULT}, Michel . \emph{Microfísica do poder.} 8ª. ed. Rio de
Janeiro: Graal, 1989.

\versal{GREGÓRIO}, Rafael. \emph{Omo, Coca-Cola, Nike e Samsung são as marcas
...
\versal{KIM}, Chan \& \versal{MAUBORGNE}, Renée. \emph{A Estratégia do Oceano Azul --
como criar novos mercados e tornar a concorrência irrelevante}. Rio de
Janeiro: Campus, 2005.

\versal{KOTLER}, P.; \versal{KELLER}, Kevin L. \emph{Administração de marketing.} 14.
ed. São Paulo: Pearson Prentice Hall, 2013.

\versal{LAZZARATO}, Maurizio. \emph{As revoluções do capitalismo.} Civilização
Brasileira, 2006.

\versal{LAZZARATO}, Maurizio. \emph{Signos, máquinas e subjetividades.} São
Paulo: Edições \versal{SESC-SP}: n-1 edições, 2014.

\versal{LIMA}, M.; \versal{SAPIRO}, A.; \versal{VILHENA}, J.B.; \versal{GANGANA}, M. \emph{Gestão de Marketing} -- 8ª edição revista e atualizada. Rio de Janeiro: Editora
\versal{FGV}, 2007.

\versal{MCINTYRE}, Ewan; \versal{VIRZI}, Anna Maria. \emph{\versal{CMO} Spend Survey 2017-2018:
...
\versal{SIMON}, Herbert A. \emph{Designing Organizations for an
