...
\begin{flushright}
\emph{Carla Oliveira\footnote{Bacharel em Ciência da Computação pela \versal{FASP}, \versal{MBA} em Gestão de Projetos e Processos pelo Centro Estadual de Educação Tecnológica Paula Souza. Atualmente, cursa mestrado em Ciências Humanas e Sociais na \versal{UFABC}.}}
\end{flushright}
...
and Intelligence}'' (\versal{TURING}, 1950, p. 1), na revista inglesa, \emph{Mind}.
...
Inteligência Artificial, na área de reconhecimento de fala e tradução (\versal{MATTHEW} \emph{et al.}, 2018). A meta era criar ferramentas que pudessem identificar as personalidades dos eleitores
