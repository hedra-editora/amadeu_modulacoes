...
Dartmouth, em 1956 (Júnior e Lima, 2010). Pesquisas relacionadas a \versal{IA}
...
japonesa do jogo de xadrez) estava longe de atingir a \versal{IA} (Sugomori,
2016).
...
cotidiana (\versal{LAZZARATO}, 2014, 34-35).
...
De acordo com Hazelwood et al (2018), o ``\emph{\versal{FBL}earner Flow}'' faz
...
\versal{AMORIM}, Paula Fernanda Patrícia de. \textbf{A crítica de John Searle à
...
\versal{BIDDLE}, Sam. \textbf{Facebook usa inteligência artificial para prever o
...
\versal{BORINI}, Guilherme. \textbf{Facebook investe \versal{US}\$ 30 milhões para
...
\versal{CADWALLADR}, Carole. \textbf{The Cambridge Analytica Files - `I made
...
\versal{CADWALLADR}, Carole e \versal{GRAHAM-HARRISON}, Emma. \textbf{Revealed: 50 million
...
\versal{GUARESCHI}, Pedrinho A; \versal{AMON}, Denise e \versal{GUERRA}, André. \textbf{Psicologia,
Comunicação e Pós-verdade}. Porto Alegre: Abrapso, 2017. P. 83-100.

\versal{DELEUZE}, Gilles. \textbf{Conversações}. São Paulo: Editora 34. 1992.

\versal{DOMINGOS}, Pedro. \textbf{O algoritmo mestre}. São Paulo: Novatec. 2017.

\versal{FOUCAULT}, Michel. \textbf{Microfísica do Poder}. Rio de Janeiro: Paz \&
Terra, 2015.

\versal{GUARESCHI}, Pedrinho. Ensaio 5 -- ``Psicologia e Pós-Verdade''. In:
\versal{GUARESCHI}, Pedrinho A; \versal{AMON}, Denise e \versal{GUERRA}, André. \textbf{Psicologia,
Comunicação e Pós-verdade}. Porto Alegre: Abrapso, 2017. P. 161-193.

\versal{HAAS}, Guilherme. \textbf{Google compra DeepMind, startup de programação
...
\versal{HAZELWOOD}, Kim, et al. \textbf{Applied Machine Learning at Facebook: A
...
\versal{KOSINSKI}, Michal, \versal{WANG}, Yilun, \versal{LAKKARAJU}, Himabindu e \versal{LESKOVEC}, Jure.
...
\versal{LAZZARATO}, Maurizio. \textbf{Signos, Máquinas, Subjetividades.} São
Paulo: Edições Sesc, 2014.

\versal{MATTHEW}, Rosenberg et al. \textbf{How Trump Consultants Exploited the
...
\versal{MCCULLOCH}, Warren S. e \versal{PITTS}, Walter. \textbf{A logical calculus of the
...
\versal{MOREIRA}, Daniel. \textbf{O que é uma startup?} 2018. Disponível em:
\textless{}https://exame.abril.com.br/pme/o-que-e-uma-startup/\textgreater{}.
Acesso em: 16 jul. 2018

\versal{PRAUDE}, Carlos Correia. \textbf{Arte Computacional e Teoria Ator-Rede:
actantes e associações intersubjetivas em cena}. Tese (Tese em Arte) -
Universidade de Brasília. Brasília. 2015.

\versal{SEARLE}, John R. \textbf{Minds, brains, and programs.} The Behavioral and
...
\versal{SUGOMORI}, Yusuke. \textbf{Java Deep Learning Essentials.} Packt
Publishing: Birmingham. 2016.

\versal{TURING}, A. M. \textbf{Computing Machinery and Intelligence}. Mind, v.
59, no. 236, p. 433-460, out. 1950. Disponível em:
\textless{}https://www.csee.umbc.edu/courses/471/papers/turi
ng.pdf\textgreater{}
Acesso em: 21 mai. 2018.

\versal{VINGE}, Vernor. \textbf{The coming technological singularity: How to
