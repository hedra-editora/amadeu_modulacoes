...
Por \emph{manipulação}, entendemos, em língua portuguesa,\footnote{Fonte:
  Dicionário Online Priberam -- \textless{}\emph{http://www.hedra.com.br/r/Zo0}\textgreater{}.} o
...
websites, e"-mails, blogs, plataformas de áudio e vídeos digitais
...
como elas ocorreram e quem as realizou (Nick Srnicek, 2017). O \emph{Big Data},
...
estratégica (\textsc{castells}, 2009, p. 76).
\end{quote}
...
odisseia chegou ao fim. O terceiro \empg{boom} está apenas começando e uma nova
...
tradicionalmente detêm o domínio na sociedade. \emph{Grosso modo}, pode"-se
...
Internet ou no âmbito \dmph{offline}, quando consomem produtos em
