...
\begin{flushright}
\emph{Sérgio Amadeu da Silveira\footnote{Sociólogo e doutor em Ciência Política pela Universidade de São Paulo (2005). É professor associado da Universidade Federal do \versal{ABC} (\versal{UFABC}).}}
\end{flushright}
...
de 2013, com o número \versal{US9928462B2}, permite obter informações
...
para determinar o estado mental do usuário\footnote{\emph{An apparatus for
  ...
  (\versal{US9928462B2}, tradução livre).} (\versal{US9928462B2}).
\end{quote}
...
um nível de confiança de 74\%\footnote{Tradução livre da descrição:
  \emph{``\ldots{} when typing speed using a keyboard is 23 characters per
    ...
    level of 74\%''.}} (\versal{US9928462B2}).
\end{quote}
...
\begin{itemize}
\item
  \versal{US-2010088607-A1} -- Sistema e método para manter o usuário sensível ao
  contexto (Yahoo);
\item
  \versal{US-2012272338-A1} -- Gerenciamento unificado de dados de rastreamento
  (Apple);
\item
  \versal{US-2012226748-A1} -- Identifique Especialistas e Influenciadores em uma
  Rede Social (Facebook);
\item
  \versal{US2018019226-3A1} -- Prever o estado futuro de um usuário de dispositivo
  móvel, (Facebook);
\item
  \versal{US20080033826-A1} -- Fornecimento de anúncios baseados no humor e na
...
\begin{Parskip}
\versal{US9928462B2} -- Apparatus and method for determining user's mental state.

\versal{US-2010088607-A1} -- System and method for maintaining context sensitive
user

\versal{US-2012272338-A1} -- Unified tracking data management

\versal{US-2012226748-A1} -- Identify Experts and Influencers in a Social Network

\versal{US2018019226-3A1} -- Predicting the future state of a mobile device user

\versal{US20080033826-A1} -- Personality-based and mood-base provisioning of
advertisements
\end{Parskip}