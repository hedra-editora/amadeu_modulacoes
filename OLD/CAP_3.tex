...
\begin{flushright}
\emph{Débora Machado\footnote{Mestranda em Ciências Humanas Sociais na \versal{UFABC} e pesquisadora do Laboratório de Tecnologias Livres da \versal{UFABC}.}}
\end{flushright}
...
tecnologia'' (\versal{SEAVER}, 2013, p. 2).\footnote{\emph{``Algorithms per se are supposed to be strictly
...
pessoas'' (\versal{KITCHIN}, 2017, p. 18).\footnote{\emph{``To create value and capital; to nudge behaviour and structure preferences in a certain way; and to identify, sort and classify people''} (Tradução nossa).} Essa dualidade no
...
influência de cada usuário, como mostra a patente \versal{US20170277691A1}
...
social do usuário'' (\versal{AGARWAL}, 2016).\footnote{\emph{``Performing an action based on the social influence score of the first user''} (Tradução nossa, online).}
...
\versal{SHARE LAB}, 21/8/2016. Disponível em: \textless{}\emph{https://bit.ly/2csMIMs}\textgreater{}. Acesso em: 11 set. 2018.
...
\versal{TOMO}, 29 jun. 2017. Disponível em: \textless{}\emph{https://bit.ly/2rAX019}\textgreater{}. Acesso em: 11 set. 2018.
