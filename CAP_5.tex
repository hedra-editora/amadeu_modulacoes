...
\begin{flushright}
\emph{Cínthia Monteiro\footnote{Graduada em Ciências Sociais -- Ênfase em Sociologia -- pela \versal{UFSC}ar. Mestranda em Ciências Humanas e Sociais pela \versal{UFABC}.}}
\end{flushright}
...
submeter sujeitos, povos, entre outros (\versal{FOUCAULT}, 1999).
...
positivistas\footnote{Positivismo: Corrente filosófica francesa que
  surgiu no começo do século \versal{XIX}. O principal idealizador do positivismo
  foi o filósofo Augusto Comte (\versal{TRINDADE}, 2007).}. Foucault destaca o
...
século \versal{XIX} e \versal{XX}, onde a ideologia de criação do ser humano perfeito
...
marginalidade (\versal{FOUCAULT}, 1999). São políticas de controle de natalidade,
...
de extrema relevância, está o enfoque no valor do imaterial\footnote{Imaterial:
  ...
  projeções de personalidade (\versal{GORZ}, 2005).}, cuja importância cada vez
mais se sobressai ao da produção em valor numérico (\versal{GORZ}, 2005). Segundo
...
produz na economia global atual (\versal{HARDT} e \versal{NEGRI}, 2009). A exploração do
...
essa nova dinâmica do capitalismo (\versal{HARDT} e \versal{NEGRI}, 2009). Essa análise
se assemelha à perspectiva marxista de consumo fetichista\footnote{Fetichismo:
  ...
  dinheiro e as commodities negociadas no mercado (\versal{MARX}, 1988).},
...
serem almejados pela classe trabalhadora (\versal{HARDT} e \versal{NEGRI}, 2009).
...
reformulada de \emph{``Self made man}''\footnote{Self made man: A
  ...
  estrutura toda a sociedade atual (\versal{WARD}, 1954).}, que não
...
prazeres dos indivíduos (\versal{FOUCAULT}, 1997).
...
social, se esvanecendo entre as inúmeras experiências cotidianas (\versal{RAUTER} e \versal{DE CASTRO PEIXOTO}, 2009). A modulação é, portanto, esse mecanismo que
...
(\versal{RAUTER} e \versal{DE CASTRO PEIXOTO}, 2009). O ideal de indivíduo bem"-sucedido em
...
Guattari chamam de \emph{axiomática do capital}\footnote{Axiomática do
  ...
  codificação e sobrecodificação das condutas (\versal{DELEUZE} e \versal{GUATTARI},
  1972/2010, \emph{apud} \versal{UHNG HUR}, 2012).}. A essa axiomática se confere a
...
modificado de acordo com as demandas mercadológicas e sociais (\versal{HUI},
...
gerenciar sua vida e seu tempo, que na realidade não existe (\versal{ZARIFIAN}, \emph{apud} \versal{HUI}, 2015). Tanto no trabalho formal quanto no
...
individuação (\versal{HUI}, 2015). A modulação é uma moldagem definitiva,
porém ajustável as mutáveis demandas do neoliberalismo.

Simondon (\emph{apud} \versal{HUI}, 2015) compara a modulação na psicologia social
...
(\versal{HUI}, 2015). Dentro desse sistema regulatório existem etapas que
...
no neoliberalismo (\versal{SAVAT}, \emph{apud} \versal{HUI}, 2015, p. 84).
...
digitização\footnote{Digitização: transformação de processos e
  ...
  (\versal{LARIVIÈRE}, 2016).} que toma conta dos mais diversos tipos de
...
algorítmos\footnote{Algorítmos: conjunto das regras e procedimentos
  ...
  um número finito de etapas (\versal{CORMEN, T. H.}, \versal{LEISERSON, C. E.}, \versal{RIVEST,
  R. L.}, \versal{STEIN, C.}, 2009).} uma das formas centrais para se obter
...
subjetividades ou como destacado por Antoinette Rouvroy (\emph{apud} \versal{HUI},
...
uma finalidade específica. O \emph{Machine learning}\footnote{\emph{Machine
  ...
  utilizados em inteligência artificial (\versal{KOSINSKI}, \versal{STILLWELL} e \versal{YOUYOU},
...
contexto de persuasão em massa (\versal{MATZA}, \versal{NAVEC}, \versal{KOSINSKI} e \versal{STILLWELL}, 2017).
...
Networks}\footnote{Redes neurais profundas (Tradução do texto de
  Kosinski e Wang, 2017).} ou \emph{\versal{DNN}}. As \emph{\versal{DNN},} são como um
...
\begin{Parskip}
\versal{BACHRACH}, Yoram. \versal{GRAEPEL}, Thore. \versal{KOHLI}, Pushmeet. \versal{KOSINSKI}, Michal.
\versal{STILLWELL}, David. \emph{Manifestations of user personality in website
choice and behaviour on online social networks}. Mach Learn (2014) 95:357--380.

\versal{CORMEN}, T. H., \versal{LEISERSON}, C. E., \versal{RIVEST}, R. L., \versal{STEIN}, C.,
\emph{Introduction to Algorithms}, 3rd edition, \versal{MIT} Press, 2009
(\textless{}\emph{https://bit.ly/2UJxjZL}\textgreater{}).

\versal{DELEUZE}, Giles. \emph{Conversações}. Tradução Peter Pál Pelbart. São Paulo: Ed. 34,  1972/1990.

\versal{DELEUZE}, Gilles \& \versal{GUATTARI}, Félix. \emph{Mil Platôs: Capitalismo e
Esquizofrenia}, vol. 5. São Paulo: 34, 1997 (1980).

\versal{DELEUZE}, Gilles \& \versal{GUATTARI}, Félix. \emph{O Anti-Édipo.} São Paulo:
34, 2010 (1972).

\versal{DELEUZE}, Giles. \emph{Postscript on the society of control.} October,
Vol. 59. (Winter, 1992), pp. 3-7.

\versal{FOUCAULT}, Michel. \emph{Arqueologia do saber.}~Rio de Janeiro:
Forense, 2008.

\versal{FOUCAULT}, Michel.~\emph{Em Defesa da Sociedade}.~São Paulo: Martins
Fontes, 1999.

\versal{FOUCAULT}, Michel. \emph{Microfísica~do Poder.} 11ª ed., Rio de
Janeiro: Graal, 1997.

\versal{FOUCAULT}, Michel.~\emph{O nascimento da Biopolítica.}~São Paulo:
Martins Fontes, 2008.

\versal{GORZ}, André. \emph{O Imaterial: Conhecimento, Valor e Capital}. São
Paulo, Editora Annablume, 2005.

\versal{HUI}, Yuk. \emph{Modulation after Control. New formations: a journal of
culture/theory/politics}, Volume 84-85, 2015. pp. 74-91 (Article).
Published by Lawrence \& Wishart.

\versal{KOSINSKI}, Michal. \versal{STILLWELL}, David. \versal{YOUYOU}, Wu. \emph{Computer-based
personality judgments are more accurate than those made by
humans}. Department of Psychology, University of Cambridge, Cambridge \versal{CB}2
3\versal{EB}, United Kingdom; Department of Computer Science, Stanford
University, Stanford, \versal{CA} 94305. Edited by David Funder, University of
California, Riverside, \versal{CA}, and accepted by the Editorial Board December
2, 2014 (received for review September28, 2014).

\versal{KOSINSKI}, Michal. \versal{WANG}, Yilun. \emph{Deep neural networks are more
accurate than humans at detecting sexual orientation from facial
images}. Graduate School of Business, Stanford University,
Stanford, \versal{CA}94305, \versal{USA}. ©American Psychological Association, 2017.

\versal{LARIVIÈRE}, Jason. \emph{Logic of digital worlds. Yuk Hui, on the
existence of digital objects.} University of Minnesota Press, 2016.
Parrhesia 27 • 2017 • 129-135.

\versal{MATZA}, S.C. \versal{NAVEC}, G. \versal{KOSINSKY}, M. \versal{STILLWELL}, D.J. \emph{Psychological targeting as an effective approach to digital mass persuasion.} Columbia
Business School, Columbia University, New York City, \versal{NY} 10027; Graduate
School of Business, Stanford University, Stanford, \versal{CA} 94305; Wharton
School of Business, University of Pennsylvania, Philadelphia, \versal{PA} 19104;
Cambridge Judge Business School, University of Cambridge, Cambridge, \versal{CB}2
3\versal{EB}, United Kingdom. Edited by Susan T. Fiske, Princeton University,
Princeton, \versal{NJ}, and approved October 17, 2017 (received for review June
17, 2017).

\versal{MARX}, Karl. \emph{O Capital}, Livro I, volume I. São Paulo: Nova
Cultural, 1988.

\versal{NEGRI}, Antonio; \versal{HARDT}, Michael. \emph{Bem-estar comum}. Rio de
Janeiro: Record, 2016.

\versal{RAUTER}, Cristina. \versal{DE CASTRO PEIXOTO}, Paulo de Tarso.
...
\versal{ROSE}, Nikolas. \emph{Psicologia como uma Ciência Social.} Psicologia
\& Sociedade, vol. 20, núm. 2, mayo-agosto, 2008, pp. 155-164.
Associação Brasileira de Psicologia Social. Minas Gerais, Brasil.

\versal{SIMONDON}, Gilbert. \emph{L'individuation à la lumière des notion de
forme et d'information.} Editions Jérôme Millon, Paris 2005, p91.
Hereafter \versal{ILFI}.

\versal{TRAVERSO-YÉPEZ}, Martha. \emph{Os discursos e a dimensão simbólica: uma
forma de abordagem à Psicologia Social.} Universidade Federal do Rio
Grande do Norte. Estudos de Psicologia 1999, 4(1), 39-59.

\versal{TRINDADE}, Hélgio (org.). \emph{O Positivismo: teoria e prática}. 3ª
ed. Porto Alegre: \versal{UFRGS}, 2007.

\versal{UHNG HUR}, Domenico. \emph{Da biopolítica à noopolítica: Contribuições de Deleuze.} \versal{LUGAR COMUM} No40, pp. 201-215.

\versal{WARD}, John William. \emph{Review of The Self-Made Man in America:
