...
uma finalidade específica. O \emph{Machine learning}\footnote{\emph{Machine
  ...
  utilizados em inteligência artificial (\versal{KOSINSKI}, \versal{STILLWELL} e \versal{YOUYOUA},
...
\versal{STILLWELL}, David. \textbf{Manifestations of user personality in website
...
\textbf{Introduction to Algorithms,} 3rd edition, \versal{MIT} Press, 2009.
Rivest, C. Stein, \emph{https://bit.ly/2UJxjZL} {\emph{Introduction
to Algorithms}}, 3rd edition, \versal{MIT} Press, 2009~\versal{DELEUZE}, Giles.
\textbf{\versal{CONVERSAÇÕES}} coleção \versal{TRANS}. Tradução Peter Pál Pelbart
1972/1990. São Paulo Ed. 34.

\versal{DELEUZE}, Gilles \& \versal{GUATTARI}, Félix. \textbf{Mil Platôs: Capitalismo e
Esquizofrenia,} Vol. 5. São Paulo: 34, 1997 (1980).

\versal{DELEUZE}, Gilles \& \versal{GUATTARI}, Félix. \textbf{O Anti-Édipo.} São Paulo:
34, 2010 (1972).

\versal{DELEUZE}, Giles. \textbf{Postscript on the society of control.} October,
Vol. 59. (Winter, 1992), pp. 3-7.

\versal{FOUCAULT}, Michel.~\textbf{Arqueologia do saber.}~Rio de Janeiro:
Forense, 2008.

\versal{FOUCAULT}, Michel.~\textbf{Em Defesa da Sociedade}.~São Paulo: Martins
Fontes, 1999.

\versal{FOUCAULT}, Michel\emph{.} \textbf{Microfísica~do Poder.} 11ª ed., Rio de
Janeiro: Graal, 1997.~

\versal{FOUCAULT}, Michel.~\textbf{O nascimento da Biopolítica.}~São Paulo:
Martins Fontes, 2008.

\versal{GORZ}, André. \textbf{O Imaterial:Conhecimento, Valor e Capital}.São
Paulo, Editora Annablume, 2005.

\versal{HUI}, Yuk. \textbf{Modulation after Control. New formations: a journal of
culture/theory/politics}, Volume 84-85, 2015. pp. 74-91 (Article).
Published by Lawrence \& Wishart.

\versal{KOSINSKI}, Michal. \versal{STILLWELL}, David. \versal{YOUYOUA}, Wu\textbf{. Computer-based
...
\versal{KOSINSKI}, Michal. \versal{WANG}, Yilun. \textbf{Deep neural networks are more
...
\versal{LARIVIÈRE}, Jason. \textbf{Logic of digital worlds. Yuk Hui, on the
existence of digital objects.} University of Minnesota Press, 2016.
Parrhesia 27 • 2017 • 129-135

\versal{MATZA}, S.C. \versal{NAVEC}, G. \versal{KOSINSKY}, M. \versal{STILLWELL}, D.J. \textbf{Psychological
...
\versal{MARX}, Karl. \textbf{O Capital}, Livro I, volume I. São Paulo: Nova
Cultural, 1988.

\versal{NEGRI}, Antonio; \versal{HARDT}, Michael.\textbf{~Bem-estar comum}. Rio de
Janeiro: Record, 2016.
...
\versal{ROSE}, Nikolas. \textbf{Psicologia como uma Ciência Social.} Psicologia
\& Sociedade, vol. 20, núm. 2, mayo-agosto, 2008, pp. 155-164.
Associação Brasileira de Psicologia Social. Minas Gerais, Brasil.

\versal{SIMONDON}, Gilbert. \textbf{L'individuation à la lumière des notion de
forme et d'information.} Editions Jérôme Millon, Paris 2005, p91.
Hereafter \versal{ILFI}.

\versal{TRAVERSO-YÉPEZ}, Martha. \textbf{Os discursos e a dimensão simbólica: uma
forma de abordagem à Psicologia Social.} Universidade Federal do Rio
Grande do Norte. Estudos de Psicologia 1999, 4(1), 39-59.

\versal{TRINDADE}, Hélgio (org.). \textbf{O Positivismo: teoria e prática}. 3ª
ed. Porto Alegre: \versal{UFRGS}, 2007.\versal{UHNG HUR}, Domenico. \textbf{Da biopolítica
à noopolítica: Contribuições de Deleuze.} \versal{LUGAR COMUM} No40, pp. 201-215.
